...
<?php include_once ('Freelancer_View_Freelancer.php');?>
...
<div class="container-fluid" style="margin-top: 70px">
  ...
  <div class="container" style="margin-top: 40px">
    <button class="btn btn_inploy">Rate Freelancer
    </button>
  </div>
    ...
    <div class="col-lg-10">
      <div class="card jobs_card">
        <div class="card-block card-content" style="padding: 20px">
          <div class="row brief-content text-center">
            <div class="col-lg-12">
        ...
        <div class="card-block card-content" style="padding: 20px">
          <div class="row brief-content">
            <div class="col-lg-12">
              <p class="content_header">Reviews</p>
            </div>
<!--            main commnet-->
