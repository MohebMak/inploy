...
<div class="container-fluid" style="margin-top: 70px">
  ...
  <div class="row" style="margin-top: 40px">
    ...
    <div class="col-md-2">
      <a href="portfolio_client_freelancer.php" class="btn btn_user_profile">
        Portfolio
      </a>
    ...
    <div class="col-md-2">
      <a href="jobs_archeived_client_fr_view.php" class="btn btn_user_profile_active">
        Jobs
      </a>
    ...
    <div class="col-md-2">
      <a href="ratings_client_freelancer.php" class="btn btn_user_profile">
        Ratings
      </a>
    ...
    <div class="col-md-2">
      <a href="followers_client_freelancer.php" class="btn btn_user_profile">
        Followers
      </a>
