...
<div class="container-fluid" style="margin-top: 70px">
  ...
  <div class="row" style="margin-top: 40px">
    ...
    <div class="col-lg-8">
      <span class="skills_header">Interested in:</span>
      <br>
    ...
    <div class="col-lg-3">
      <img src="images/icons/Create_breif-19.png" width="60" style="padding: 6px;">
  ...
  <div class="row" style="margin-top: 40px">
    ...
    <div class="col-md-3">
      <a href="ratings_client_view.php" class="btn btn_user_profile">
        Rating & Reviews
      </a>
    ...
    <div class="col-md-2">
      <a href="jobs_posted_client_view.php" class="btn btn_user_profile_active">
        Jobs
      </a>
    ...
    <div class="col-md-2">
      <a href="followers_client_view.php" class="btn btn_user_profile">
        Following
      </a>
