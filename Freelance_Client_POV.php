...
<div class="container-fluid" style="margin-top: 70px">
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      ...
      <div class="user_info">
        ...
        <p class="user_industry">Report Client</p>
  ...
  <div class="row" style="margin-top: 40px">
    ...
    <div class="col-md-3">
      <a href="ratings_freelancer_client.php" class="btn btn_user_profile">
        Rating & Reviews
      </a>
    ...
    <div class="col-md-2">
      <a href="jobs_posted_fr_view.php" class="btn btn_user_profile_active">
        Jobs
      </a>
    ...
    <div class="col-md-2">
      <a href="followers_freelancer_client.php" class="btn btn_user_profile">
        Following
      </a>
