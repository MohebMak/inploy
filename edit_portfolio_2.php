...
<div class="container" style="margin-top: 70px">
  ...
  <div class="row" style="margin-top: 20px">
    ...
    <div class="col-lg-12">
      <div class="" style="font-family: font2">
        ...
        <label style="float: none" class="label_settings">Edit Title</label>
  ...
  <div class="row" style="margin-top: 40px">
    ...
    <div class="col-lg-3">
      <div class="" style="position: relative;padding:10px">
        <img class="portfolio_img" src="images/icons/Icon-19.png" width="180" data-toggle="modal" data-target="#myModal">
