          ...
          <div class="col-lg-6">
            ...
            <div class="form-check">
              <label class="form-check-label">
                <input type="checkbox" class="form-check-input"><span style="margin-left: 5px;color: #ea4456">Notify me when I receive a brief</span>
              </label>
            </div>
            <div class="form-check">
              <label class="form-check-label">
                <input type="checkbox" class="form-check-input"><span style="margin-left: 5px;color: #ea4456">Notify me when Inploy recommends a brief</span>
              </label>
            </div>
            <div class="form-check">
              <label class="form-check-label">
                <input type="checkbox" class="form-check-input"><span style="margin-left: 5px;color: #ea4456">Notify me with a new client is availble to follow</span>
              </label>
            </div>
